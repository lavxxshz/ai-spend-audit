...
const styles = {
  ...
  steps: { display: 'flex', gap: '32px', justifyContent: 'center', flexWrap: 'wrap' },
  ...
  statsSection: { display: 'flex', justifyContent: 'center', gap: '48px', padding: '60px 20px', backgroundColor: '#4f46e5', flexWrap: 'wrap' },
